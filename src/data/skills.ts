export const skills = [
  {
    ...
    description:
      "Designing scalable, resilient services with clear boundaries and data models; making pragmatic trade-offs documented via ADRs and RFCs.",
  },
  {
    ...
    description:
      "Designing REST/GraphQL APIs, background jobs, queues, and ensuring reliability with idempotency, retries, and observability.",
  },
  {
    ...
    description:
      "Schema design, migrations, and performance tuning with Postgres; caching strategies and rate-limiting using Redis.",
  },
  {
    ...
    title: "Testing & CI/CD",
    description:
      "Unit, integration, and E2E testing (Jest, Playwright) with GitHub Actions pipelines, preview environments, and quality gates.",
  },
  {
    icon: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19 18H6a4 4 0 010-8 5 5 0 019.9-1.5A4.5 4.5 0 1119 18z"/></svg>`,
    title: "Cloud & DevOps",
    description:
      "AWS, Docker, and Terraform; enabling secure deployments, monitoring with alerts, and running cost-aware operations.",
  },
] as const;
